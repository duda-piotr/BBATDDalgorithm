#A file enabling experiments to be performed on the CIFAR dataset presented in the paper
...
ex1 = ex.experiment("CIFAR", x_train, y_train, x_test, y_test, input_shape, num_classes, model, 1)
